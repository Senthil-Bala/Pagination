...
function PageMain() {
    ...
    const paginate = (pageNumber) => {
        if (pageNumber >= 1 && pageNumber <= Math.ceil(datas.length / postsPerPage)) {
  ...
  return (
    <div>
        ...
        <Pagination paginate={paginate} totalPosts={datas.length} postsPerPage={postsPerPage} currentPage={presentPage} />    </div>
  )
}
